    ...
    <div>
        <div class="row">
            <div class="col-lg-12 text-center m-t-md" style="">
                ...
                <p>
                    Special <strong>demo app</strong> for small, medium and large webapp with very clean and
                ...
                <div class="hpanel stats">
                    <div class="panel-body h-200">
                        ...
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="flot-income-chart" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 346px; height: 60px;" width="346" height="60"></canvas><canvas class="flot-overlay" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 346px; height: 60px;" width="346" height="60"></canvas></div>
                        </div>
                        <div class="m-t-xs">
